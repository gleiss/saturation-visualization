  ...
  static fromParsedLines(parsedLines: Array<ParsedLine>, existingDag: Dag | null): Dag {
    ...
    for (const line of parsedLines) {
      if (line.type === "preprocessing") {
        // line represents the generation of a clause during preprocessings
        assert(existingDag === null, "extending dag with lines from saturation, so no new preprocessing lines should occur!")
