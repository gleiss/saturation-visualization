...
export class Dag {
  ...
  static fromParsedLines(parsedLines: Array<ParsedLine>, existingDag: Dag | null): [Dag, Array<number>] {
    const nodes = (existingDag === null) ? new Map<number, SatNode>() : new Map<number, SatNode>(existingDag.nodes);
    const newNodes = new Array<number>(); // keep track of newly added nodes
